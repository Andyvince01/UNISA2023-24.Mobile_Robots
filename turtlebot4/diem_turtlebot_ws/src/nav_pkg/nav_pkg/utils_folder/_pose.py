...
from geometry_msgs.msg import Point  # noqa: E402, I100
from ._orientation import Orientation  # noqa: E402, I100
...
class Pose(metaclass=Metaclass_Pose):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['orientation'], 'Orientation'),  # noqa: E501
    )
              
    # Constructor for the Pose class.
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        # Set the position field to the value passed as an argument.
        from geometry_msgs.msg import Point
    ...
    def orientation(self, value):
        if __debug__:
            assert \
                ...
                f"The 'orientation' field must be a sub message of type 'Orientation {value}'"
        self._orientation = value

    # Get Pose value by passing Point and Quaternion values
    @classmethod
    def get_pose(**kwargs):
        from geometry_msgs.msg import Point
        position = kwargs.get('position', Point())
