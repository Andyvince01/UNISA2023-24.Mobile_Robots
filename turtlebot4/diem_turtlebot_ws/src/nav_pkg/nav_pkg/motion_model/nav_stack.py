...
def main():
    ...
    goal_pose.append(navigator.getPoseStamped([2.0, -1.0], TurtleBot4Directions.WEST))
    goal_pose.append(navigator.getPoseStamped([2.0, 0.0], TurtleBot4Directions.WEST))
    goal_pose.append(navigator.getPoseStamped([2.0, 1.0], TurtleBot4Directions.NORTH))
